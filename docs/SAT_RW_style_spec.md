# Practice Test 8 — Reading & Writing Build Brief
...
| `command-of-evidence` | 2 | Information and Ideas |
| `inferences` | 3 | Information and Ideas |
| `boundaries` | 9 | Standard English Conventions |
| `form-structure-sense` | 10 | Standard English Conventions |
| `transitions` | 7 | Expression of Ideas |
| `rhetorical-synthesis` | 8 | Expression of Ideas |
...
**Test 8 keyed transitions — PRE-ASSIGNED, do not deviate (each is unique across the whole form):**

| item | key (verbatim, with comma) | relation |
|---|---|---|
| M1 Q22 (easy) | `As a result,` | cause-result |
| M1 Q23 (medium) | `However,` | contrast-concession |
| M1 Q24 (hard) | `In fact,` | correction-emphasis |
| M2 Q23 (medium) | `Specifically,` | example |
| M2 Q24 (medium) | `In addition,` | addition |
| M2 Q25 (hard) | `Instead,` | replacement |
