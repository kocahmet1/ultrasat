/**
 * Validate scripts/data/practiceTest8RW.json — the two R&W replacement modules
 * for Exam 8 — against the production schema and College Board consistency rules.
 *
