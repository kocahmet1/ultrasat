/**
 * Generate the human-readable editorial review for Practice Test 3 R&W.
 *
 * Usage: node scripts/generatePracticeTest3RWReview.js
 */
...
const outputPath = path.resolve(__dirname, '..', 'PracticeTest3_ReadingWriting_review.html');
...
<title>Practice Test 3 — Reading &amp; Writing Editorial Review</title>
<style>
...
<body>
<h1>Practice Test 3 — Reading &amp; Writing</h1>
<p style="color:#555">${data.modules.reduce((sum, mod) => sum + mod.questions.length, 0)} original questions across two modules. The correct choice is marked ✓. This file is generated directly from <code>scripts/data/practiceTest3RW.json</code> for editorial review; production deployment is a separate step.</p>`];
