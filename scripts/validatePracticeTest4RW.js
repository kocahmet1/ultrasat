/**
 * Validate scripts/data/practiceTest4RW.json — the two R&W replacement modules
 * for Exam 4 — against the production schema and College Board consistency rules.
 *
