/**
 * Validate scripts/data/practiceTest5RW.json — the two R&W replacement modules
 * for Exam 5 — against the production schema and College Board consistency rules.
 *
