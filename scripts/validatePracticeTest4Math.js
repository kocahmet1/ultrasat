/**
 * Validate scripts/data/practiceTest4Math.json — the two Math replacement
 * modules (moduleNumber 3 and 4) for Exam 4 — against the production schema,
 ...
 *
 * Usage: node scripts/validatePracticeTest4Math.js
 */
