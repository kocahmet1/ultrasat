/**
 * Generate the human-readable editorial review for Practice Test 5 R&W.
 *
 * Usage: node scripts/generatePracticeTest5RWReview.js
 */
...
const outputPath = path.resolve(__dirname, '..', 'PracticeTest5_ReadingWriting_review.html');
...
<title>Practice Test 5 — Reading &amp; Writing Editorial Review</title>
<style>
...
<body>
<h1>Practice Test 5 — Reading &amp; Writing</h1>
<p style="color:#555">${data.modules.reduce((sum, mod) => sum + mod.questions.length, 0)} original questions across two modules. The correct choice is marked ✓. This file is generated directly from <code>scripts/data/practiceTest5RW.json</code> for editorial review; production deployment is a separate step.</p>`];
