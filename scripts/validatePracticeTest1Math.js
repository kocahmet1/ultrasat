/**
 * Validate scripts/data/practiceTest1Math.json — the two Math replacement
 * modules (moduleNumber 3 and 4) for Exam 1 — against the production schema,
 ...
 *
 * Usage: node scripts/validatePracticeTest1Math.js
 */
