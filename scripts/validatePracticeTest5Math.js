/**
 * Validate scripts/data/practiceTest5Math.json — the two Math replacement
 * modules (moduleNumber 3 and 4) for Exam 5 — against the production schema,
 ...
 *
 * Usage: node scripts/validatePracticeTest5Math.js
 */
