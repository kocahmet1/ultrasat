...
const verifyFirebaseToken = requireAuth({
  logLabel: '[QuestionQuality] Error verifying token',
});
...
const verifyAdminAccess = requireAdmin({
  authLogLabel: '[QuestionQuality] Error verifying token',
  adminLogLabel: '[QuestionQuality] Error checking admin access',
});
