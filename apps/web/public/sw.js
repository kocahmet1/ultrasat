...
const STATIC_CACHE = 'ultrasat-static-v1.3.0';
const DYNAMIC_CACHE = 'ultrasat-dynamic-v1.3.0';
const IMAGE_CACHE = 'ultrasat-images-v1.3.0';
...
console.log('UltraSAT Service Worker loaded with advanced caching strategies');
