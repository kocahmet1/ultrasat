  ...
  useEffect(() => {
    const loadExam = async () => {
      try {
        ...
        const initialResponses = createInitialModuleResponses(sortedModules);
        ...
        if (shouldStartExam) {
          ...
          setModuleResponses(createInitialModuleResponses(sortedModules));
          setExamStatus('in-progress');
