...
const Blog = () => {
  ...
  }, [fetchBlogPosts, postsPerPage, searchTerm]);

  useEffect(() => {
    fetchBlogPosts();
    fetchFeaturedPosts();
  }, [currentPage, fetchBlogPosts, fetchFeaturedPosts, selectedCategory, selectedTag]);
  ...
  }, [fetchBlogPosts, handleSearch, searchTerm]);
