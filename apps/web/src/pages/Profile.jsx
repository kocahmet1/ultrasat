...
import { FaBook, FaClipboardCheck, FaTrophy, FaBullseye, FaQuestionCircle, FaMedal, FaChartLine, FaSpinner } from 'react-icons/fa';
...
function Profile() {
  const { currentUser, getUserResults, userMembership, loading } = useAuth();
  const [error] = useState('');
  const [, setNotificationStatus] = useState('unknown');
