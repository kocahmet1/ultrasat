...
// Legacy Collection: targetedQuizzes
// Purpose: Retired small-skill quiz model kept only for compatibility redirects
/*
{
  id: string,                // Auto-generated Firestore ID
...
// Collection: smartQuizzes
// Purpose: User-generated SmartQuiz sessions
/*
{
  id: string,                // Auto-generated Firestore ID
  userId: string,            // Reference to the owner
  questionIds: array,        // Ordered question IDs for the session
  subcategoryId: string,     // Primary subcategory for single-focus quizzes
  subcategoryIds: array,     // Multiple subcategories for mixed SmartQuizzes
  level: number,             // 1-3 current difficulty level
  questionCount: number,     // Number of generated questions
  status: string,            // in_progress, completed, abandoned, etc.
  score: number,             // Latest recorded score
  wrongConcepts: array,      // Concepts identified from wrong answers
  analysisComplete: boolean, // Whether concept analysis has completed
  createdAt: timestamp,      // When the SmartQuiz was created
  updatedAt: timestamp,      // Last SmartQuiz update
  completedAt: timestamp     // When the SmartQuiz was completed
}
*/
...
/*
{
  ...
  recommendedPracticeSubcategories: array, // SmartQuiz targets keyed by subcategory
