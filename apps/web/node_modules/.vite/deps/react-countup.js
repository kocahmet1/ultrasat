import { n as __commonJSMin, t as require_react } from "./react-kuU0FWQ8.js";
		...
		t.CountUp = function() {
			function t(t, n, s) {
				...
				this.endVal = n, this.options = s, this.version = "2.8.1", this.defaults = {
					...
					a.frameVal = (a.countDown ? a.frameVal < a.endVal : a.frameVal > a.endVal) ? a.endVal : a.frameVal, a.frameVal = Number(a.frameVal.toFixed(a.options.decimalPlaces)), a.printValue(a.frameVal), i < a.duration ? a.rAF = requestAnimationFrame(a.count) : null !== a.finalEndVal ? a.update(a.finalEndVal) : a.options.onCompleteCallback && a.options.onCompleteCallback();
			...
			return t.prototype.handleScroll = function(t) {
				...
				if (Math.abs(i) > this.options.smartEasingThreshold && this.options.useEasing) {
					this.finalEndVal = t;
					this.endVal = t + (this.countDown ? 1 : -1) * this.options.smartEasingAmount, this.duration = this.duration / 2;
