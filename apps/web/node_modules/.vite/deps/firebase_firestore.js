import { A as getDefaultEmulatorHostnameAndPort, D as deepEqual, L as isIndexedDBAvailable, M as getModularInstance, N as getUA, S as FirebaseError, T as createMockUserToken, V as isSafari, b as Component, c as _getProvider, f as getApp, g as registerVersion, l as _registerComponent, n as SDK_VERSION, u as _removeServiceInstance, v as LogLevel, y as Logger } from "./index.esm2017-C9SvAURc.js";
...
function Cd(a, b, c) {
	...
	d || (c = Bd(c), "string" === typeof a ? null != c && encodeURIComponent(String(c)) : K$1(a, b, c));
}
function Dd(a, b, c) {
...
var Mu = class extends class {
	constructor(t) {
		...
		this.mo = (t.ssl ? "https" : "http") + "://" + t.host, this.yo = "projects/" + this.databaseId.projectId + "/databases/" + this.databaseId.database + "/documents";
	}
	get po() {
		return !1;
	}
...
*/ (function(t, e = !0) {
	...
	}), "PUBLIC").setMultipleInstances(!0)), registerVersion(b, "3.13.0", t), registerVersion(b, "3.13.0", "esm2017");
})();
//#endregion
