...
var e, t, n, i, r = function(e, t) {
	return {
		...
		delta: 0,
		entries: [],
		id: "v2-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 0xe8d4a51000)
	};
}, a = function(e, t) {
	try {
	...
	return "hidden" === document.visibilityState ? 0 : Infinity;
}, m = function() {
	o((function(e) {
		f = e.timeStamp;
	}), !0);
	...
	passive: !0,
	capture: !0
}, y = /* @__PURE__ */ new Date(), g = function(i, r) {
	e || (e = r, t = i, n = /* @__PURE__ */ new Date(), w(removeEventListener), E());
}, E = function() {
	if (t >= 0 && t < n - y) {
		var r = {
...
//#endregion
export { h as getCLS, d as getFCP, L as getFID, F as getLCP, P as getTTFB };
