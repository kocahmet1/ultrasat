import { n as __commonJSMin, o as __toESM, t as require_react } from "./react-DYWxYg_L.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { t as require_prop_types } from "./prop-types-fOD4Bedj.js";
import { t as clsx } from "./clsx-DB9f7WqQ.js";
import { t as _extends } from "./extends-DhwtUK79.js";
import { a as memoize$1, i as init_emotion_memoize_esm, n as init_emotion_is_prop_valid_esm, r as isPropValid } from "./emotion-is-prop-valid.esm-Cmdtth5x.js";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider$1, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeContext$1.Provider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RtlProvider, {
				value: rtlValue,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DefaultPropsProvider$1, {
...
function createPalette(palette) {
	const { mode = "light", contrastThreshold = 3, tonalOffset = .2, ...other } = palette;
...
function shouldSkipGeneratingVar(keys) {
	return !!keys[0].match(/(cssVarPrefix|colorSchemeSelector|rootSelector|typography|mixins|breakpoints|direction|transitions)/) || !!keys[0].match(/sxConfig$/) || keys[0] === "palette" && !!keys[1]?.match(/(mode|contrastThreshold|tonalOffset)/);
}
//#endregion
...
function createThemeWithVars(options = {}, ...args) {
	...
	if (builtInLight && !colorSchemes.light) attachColorScheme$1(colorSchemes, builtInLight, void 0, "light");
	if (builtInDark && !colorSchemes.dark) attachColorScheme$1(colorSchemes, builtInDark, void 0, "dark");
	let theme = {
		defaultColorScheme,
		...muiTheme,
		cssVarPrefix,
	...
	Object.keys(theme.colorSchemes).forEach((key) => {
		...
		if (palette.mode === "light") {
			...
			setColor(palette.LinearProgress, "primaryBg", private_safeLighten(palette.primary.main, .62));
		...
		if (palette.mode === "dark") {
			...
			setColor(palette.LinearProgress, "primaryBg", private_safeDarken(palette.primary.main, .5));
...
function createTheme(options = {}, ...args) {
	const { palette, cssVariables = false, colorSchemes: initialColorSchemes = !palette ? { light: true } : void 0, defaultColorScheme: initialDefaultColorScheme = palette?.mode, ...rest } = options;
...
//#endregion
export { useTheme$2 as $, orange as A, darken as B, duration as C, composeClasses as Ct, green as D, deepmerge as Dt, createMixins as E, exactProp as Et, createContainer as F, hexToRgb as G, emphasize as H, createCssVarsProvider as I, recomposeColor as J, hslToRgb as K, ThemeProvider as L, purple as M, grey as N, lightBlue as O, common as P, styled$1 as Q, useRtl as R, createTransitions as S, ClassNameGenerator as St, createTypography as T, useEnhancedEffect as Tt, getContrastRatio as U, decomposeColor as V, getLuminance as W, useThemeProps as X, rgbToHex as Y, getThemeProps$1 as Z, createThemeWithVars as _, resolveBreakpointValues as _t, useDefaultProps as a, css as at, createColorScheme as b, generateUtilityClasses as bt, internal_createExtendSxProp as c, createCache as ct, slotShouldForwardProp as d, styleFunctionSx as dt, useTheme$3 as et, GlobalStyles as f, createUnarySpacing as ft, createTheme as g, mergeBreakpointsInOrder as gt, defaultTheme as h, handleBreakpoints as ht, svgIconClasses as i, styled$2 as it, red as j, blue as k, styled as l, StyleSheet as lt, identifier_default as m, getPath as mt, SvgIcon as n, createSpacing as nt, memoTheme as o, keyframes as ot, useTheme as p, getValue as pt, lighten as q, getSvgIconUtilityClass as r, createBreakpoints as rt, globalCss as s, CacheProvider as st, createSvgIcon as t, createTheme$1 as tt, rootShouldForwardProp as u, extendSxProp as ut, excludeVariablesFromRoot as v, capitalize_default as vt, easing as w, resolveProps as wt, getOverlayAlpha as x, generateUtilityClass as xt, shouldSkipGeneratingVar as y, clamp as yt, alpha as z };

//# sourceMappingURL=createSvgIcon-C-qRIpJf.js.map